...
//	}
	...
	public ConstructorConcept(String name, int age, char gender, String dob) {
		this.name = name;
		this.age = age;
		this.gender = gender;
		this.dob = dob;
	...
	public ConstructorConcept(String name, int age, double salary, char gender, String dob, boolean isPerm) {
		this.name = name;
		this.age = age;
		this.salary = salary;
		this.gender = gender;
	...
	public static void main(String[] args) {
		ConstructorConcept e1 = new ConstructorConcept("Priya", 30);
		System.out.println(e1.name + " " + e1.age + " " + e1.salary + " " + e1.dob + " " + e1.isPerm);
		e1.salary = 23.44;
		System.out.println(e1.name + " " + e1.age + " " + e1.salary + " " + e1.dob + " " + e1.isPerm);


		ConstructorConcept e2 = new ConstructorConcept("Devesh", 25, 30.66, 'm');
		System.out.println(e2.name + " " + e2.age + " " + e2.salary + " " + e2.dob + " " + e2.isPerm + " " + e2.gender);
		
		ConstructorConcept e3 = new ConstructorConcept("naveen", 25, 12.33, 'm', "01-01-2000", true);
