...
public class IncrementDecrementOperators {
	...
	public static void main(String[] args) {
		// ++ and --
				...
				// 1. post increment: give the original value first to left side value, then increase it by 1
				int a = 1;
				int b = a++;
//				
		//initially a=1, give this immediately to j, then increase the value by 1
