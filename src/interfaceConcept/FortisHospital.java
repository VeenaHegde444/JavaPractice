...
public class FortisHospital extends Medical implements USMedical, UKMedical, IndianMedical{
	...
	//a class can extend 1 parent as well as implements many interfaces
	//sequence should be 'extends' followed by 'implements'
	//we have 4 parents for this class, 1 class & 3 interfaces
